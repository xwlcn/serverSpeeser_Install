...
URLKernel='https://raw.githubusercontent.com/xwlcn/serverSpeeder_kernel/master/serverSpeeder.txt'
...
wget --no-check-certificate -q -O "/tmp/appex/apxfiles/bin/acce-"$KNV"-["$KNA"_"$KNN"_"$KNK"]" "https://raw.githubusercontent.com/xwlcn/serverSpeeder_kernel/master/$MyKernel"
...
{
[ ! -f /tmp/appex.zip ] && wget --no-check-certificate -q -O "/tmp/appex.zip" "https://raw.githubusercontent.com/xwlcn/serverSpeeser_Install/master/appex.zip"
